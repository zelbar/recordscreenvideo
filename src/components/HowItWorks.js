...
import { Grid, Header, Item } from 'semantic-ui-react/dist/commonjs';
    ...
    <Grid.Row>
      <Item.Group divided relaxed>
        ...
        <Item>
          ...
          <Item.Content>
            <Item.Header as='h4'>Pick recording area</Item.Header>
            <Item.Description>
              ...
              <p>The video resolution will be set to match the recording area.</p>
            </Item.Description>
          </Item.Content>
        </Item>
